...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            var targetForward = my_Target.transform.forward;
            var targetUp = my_Target.transform.up;
            ...
            transform.position = Vector3.Lerp(transform.position, my_Target.transform.position, deltaTime*m_MoveSpeed);
